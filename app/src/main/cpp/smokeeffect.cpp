...
"    float incend = smokeSource.z * max(sourceSize-dist,0.0);\n"
"    gl_FragColor.rgba += incend;\n"
"\n"
"    //Smoke diffuse\n"
...
void SmokeEffect::drawFrame()
{
  ...
  glUniform1f(_sourceSizeId, 15.f);
  glUniform3f(_smokeSourceId, _width*_mousePos.x, _height*_mousePos.y, 0.1f);
